...
<body>
	...
	<div class="topnav">
		<div class="topnav_bd w990 bc">
			...
			<div class="topnav_right fr">
				<ul>
					<li>您好，欢迎来到如意商城！[<a href="/user/login">登录</a>] [<a href="/user/regist">免费注册</a>] </li>
					<li class="line">|</li>
					<li>我的订单</li>
					<li class="line">|</li>
					<li>客户服务</li>
	...
	<div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="/static/index.html"><img src="/static/images/logo.jpg" alt="如意商城"></a></h2>
		</div>
	</div>
	<!-- 页面头部 end -->
		...
		<div class="login_bd">
			<div class="login_form fl">
				...
				<div class="coagent mt15">
					<dl>
						<dt>使用合作网站登录商城：</dt>
                        <dd class="qq"><a href="http://www.qq.com"><span></span>QQ</a></dd>
                        <dd class="weibo"><a href="http://www.weibo.com"><span></span>新浪微博</a></dd>
                        <dd class="yi"><a href="http://www.wangyi.com"><span></span>网易</a></dd>
                        <dd class="renren"><a href="http://www.renren.com"><span></span>人人</a></dd>
                        <dd class="qihu"><a href="http://www.360.cn"><span></span>奇虎360</a></dd>
                        <dd class=""><a href="http://www.baidu.com"><span></span>百度</a></dd>
                        <dd class="douban"><a href="http://www.douban.com"><span></span>豆瓣</a></dd>
					</dl>
				</div>
			</div>
