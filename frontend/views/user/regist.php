...
<body>
	...
	<div class="header w990 bc mt15">
		<div class="logo w990">
			<h2 class="fl"><a href="index.html"><img src="/static/images/logo.jpg" alt="如意商城"></a></h2>
		</div>
	</div>
	<!-- 页面头部 end -->
			...
			<div class="login_form fl">
				<form action="" method="post" id="reg_form">
                    ...
                    <ul>
						...
						<li>
							<label for="">&nbsp;</label>
							<input type="button" value="" class="login_btn" id="login_btn" />
						</li>
					</ul>
				</form>
	...
	<div class="footer w1210 bc mt15">
		...
		<p class="copyright">
			 © 2008-2018 Demon网上商城 版权所有，并保留所有权利。  ICP备案证书号:京ICP证070359号
		</p>
		<p class="auth">
